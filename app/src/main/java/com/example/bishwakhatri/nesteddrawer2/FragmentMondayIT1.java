 ...
 */
public class FragmentMondayIT1 extends Fragment {
    ListView listViewMondaytIT1;


    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // return inflater.inflate(R.layout.fragment_sundayit1, container, false);
        View V = inflater.inflate(R.layout.fragment_monday_it1, container, false);

        listViewMondaytIT1= (ListView) V.findViewById(R.id.listViewMondayIT1);
        ...
        listViewMondaytIT1.setAdapter(adaptor);
