 ...
 */
public class FragmentWednesdayIT1 extends Fragment {
    ListView listViewWedIT1;


    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // return inflater.inflate(R.layout.fragment_sundayit1, container, false);
        View V = inflater.inflate(R.layout.fragment_wednesday_it1, container, false);

        listViewWedIT1= (ListView) V.findViewById(R.id.listViewWednesdayIT1);
        ...
        routineCustomlists.add(new RoutineCustomlist("13:45-15:15","PST","A304","RRA","L","PST","A304","RRA","L"));
        ...
        listViewWedIT1.setAdapter(adaptor);
