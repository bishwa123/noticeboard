 ...
 */
public class FragmentSundayIT1 extends Fragment{

    ListView listViewsunIT1;


    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       // return inflater.inflate(R.layout.fragment_sundayit1, container, false);
        View V = inflater.inflate(R.layout.fragment_sundayit1, container, false);


        listViewsunIT1= (ListView) V.findViewById(R.id.listViewSundayIT1);
      ...
      //  routineCustomlists.add(new RoutineCustomlist());
        ...
        routineCustomlists.add(new RoutineCustomlist("13:45-15:15","PRGC","C106","DM","L","PRGC","C106","DM","L"));
        ...
        listViewsunIT1.setAdapter(adaptor);
