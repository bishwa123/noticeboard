 ...
 */
public class FragmentThursdayT1 extends Fragment {

    ListView listViewThuIT1;


    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // return inflater.inflate(R.layout.fragment_sundayit1, container, false);
        View V = inflater.inflate(R.layout.fragment_thursday_it1, container, false);
       
        listViewThuIT1= (ListView) V.findViewById(R.id.listViewThursdayIT1);
        ...
        listViewThuIT1.setAdapter(adaptor);
