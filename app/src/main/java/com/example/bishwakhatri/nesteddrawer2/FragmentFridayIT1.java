 ...
 */
public class FragmentFridayIT1 extends Fragment {
    ListView listViewFriIT1;


    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // return inflater.inflate(R.layout.fragment_sundayit1, container, false);
        View V = inflater.inflate(R.layout.fragment_friday_it1, container, false);

        listViewFriIT1= (ListView) V.findViewById(R.id.listViewFridayIT1);
        ...
        listViewFriIT1.setAdapter(adaptor);
